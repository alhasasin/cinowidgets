...
* Dynamic routes for About, Products, Contact pages
* JSON API for chatbot communication
...
| -------------- | -------------------------------- |
| `/`            | Homepage                         |
| `/products`    | List of bakery products          |
| `/about`       | About CINO Bakery                |
| `/contact`     | Contact page                     |
| `/chat-widget` | Embedded floating chatbot widget |

---

### 🤖 Smart Chatbot Capabilities

The chatbot understands multiple intents:

* **Greetings**
* **Bread inquiries** (sizes, prices, fresh loaves)
* **Snacks & pastries**
* **Price questions**
* **Location & address**
* **Phone & contact info**
...
Handles unknown messages with friendly fallback responses.
...
```bash
git clone https://github.com/yourusername/cino-bakery.git
cd cino-bakery
```
